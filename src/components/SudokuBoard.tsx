                ...
                {row.map((cell, colIndex) => {
                  ...
                  return (
                    <td
                      ...
                      className={`h-12 w-12 cursor-pointer select-none border bg-white text-center align-middle text-base font-semibold transition sm:h-14 sm:w-14 ${selected
                          ? isFixed
                        ...
                        } ${selected ? "ring-2 ring-emerald-500 ring-inset" : ""} ${colIndex % 3 === 0 ? "border-l-2 border-slate-400" : "border-l border-slate-300"
